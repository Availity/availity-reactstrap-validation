...
describe('AvForm', function() {
  ...
  describe('instance functions', () => {
    ...
    describe('validate one', () => {
      ...
      //   console.log("How we do?",this.instance.validateOne(inputName, {}))
      //   expect(this.instance.validateOne(inputName, {})).returns(true);
      // });
      ...
      describe('when validate is something else', () => {
        ...
        //   const context = { [inputName]: inputValue };
        //   this.instance._inputs = { [inputName]: input };
        //   expect(this.instance.validateOne(inputName, context)).to.be.true;
        // });
      });
    });
    ...
    describe('validate all', () => {
      ...
      describe('form level validation', () => {
        ...
        //   const context = {};
        //   expect(this.instance.validateAll(context)).to.have.deep.include({ isValid: false, errors: ['*'] });
        // });
        ...
        //   this.wrapper.setProps({ validate: [spy1, spy2] });
        //   const context = {};
        //   expect(this.instance.validateAll(context)).to.have.deep.include({ isValid: true, errors: [] });
        // });
      });
    });
