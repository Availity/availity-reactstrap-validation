...
describe('Min Validation', () => {
  ...
  it('should return false by default when field is over the max', () => {
    expect(fn(1, undefined, {value: 5})).to.be.false;
  });

  it('should return custom error message if provided when field is over the max', () => {
    expect(fn(1, undefined, {value: 5, errorMessage: 'Too much!'})).to.equal('Too much!');
  });

  it('should accept string input', () => {
    expect(fn('12', undefined, {value: '2'})).to.be.true;
    expect(fn('12', undefined, {value: 2})).to.be.true;
    expect(fn('12', undefined, {value: '20'})).to.be.false;
    expect(fn('12', undefined, {value: 20})).to.be.false;
  });
  ...
  it('should accept string constraint input', () => {
    ...
    expect(fn(10, undefined, {value: '2'})).to.be.true;
    expect(fn('3', undefined, {value: '20'})).to.be.false;
    expect(fn(3, undefined, {value: '20'})).to.be.false;
  });
  ...
  it('should accept numeric input', () => {
    expect(fn(10, undefined, {value: '2'})).to.be.true;
    expect(fn(10, undefined, {value: 2})).to.be.true;
    expect(fn(2, undefined, {value: '10'})).to.be.false;
    expect(fn(2, undefined, {value: 10})).to.be.false;
  });
  ...
  it('should accept decimal input', () => {
    expect(fn('10.5', undefined, {value: 2})).to.be.true;
    expect(fn(10.5, undefined, {value: 2})).to.be.true;
    expect(fn('1.5', undefined, {value: 10})).to.be.false;
    expect(fn(1.5, undefined, {value: 10})).to.be.false;
  });

  it('should accept decimal constraint input', () => {
    expect(fn(10.5, undefined, {value: 2.2})).to.be.true;
    expect(fn(10.5, undefined, {value: '2.2'})).to.be.true;
    expect(fn(3.5, undefined, {value: 20.2})).to.be.false;
    expect(fn(3.5, undefined, {value: '20.2'})).to.be.false;
  });


  it('should compare dates when date validation is on', () => {
    expect(fn('2016-10-08', undefined, {value: '2016-10-10'}, {validations: {date: {value: true}}})).to.be.false;
    expect(fn('2016-10-09', undefined, {value: '2016-10-10'}, {validations: {date: {value: true}}})).to.be.false;
    expect(fn('2016-10-10', undefined, {value: '2016-10-10'}, {validations: {date: {value: true}}})).to.be.true;
    expect(fn('2016-10-11', undefined, {value: '2016-10-10'}, {validations: {date: {value: true}}})).to.be.true;
  });

  it('should compare dates when the field is of type date', () => {
    expect(fn('2016-10-08', undefined, {value: '2016-10-10'}, {props: {type: 'date'}})).to.be.false;
    expect(fn('2016-10-09', undefined, {value: '2016-10-10'}, {props: {type: 'date'}})).to.be.false;
    expect(fn('2016-10-10', undefined, {value: '2016-10-10'}, {props: {type: 'date'}})).to.be.true;
    expect(fn('2016-10-11', undefined, {value: '2016-10-10'}, {props: {type: 'date'}})).to.be.true;
  });
});
